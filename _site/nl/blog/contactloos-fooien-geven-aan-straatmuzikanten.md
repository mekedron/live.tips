# Contactloos fooien geven aan straatmuzikanten, eerlijk gerekend

> Tap to Pay op een telefoon, een kaartlezer, een NFC-sticker, een QR-code — vier verschillende dingen die allemaal 'contactloos' heten. Wat elk daarvan in 2026 echt kost, wat een NFC-tag werkelijk doet (niet wat je denkt), en wanneer een tap een scan verslaat.

Canonical: https://live.tips/nl/blog/contactloos-fooien-geven-aan-straatmuzikanten/
...
aannemen](https://live.tips/nl/blog/kaartbetalingen-voor-straatmuzikanten/) en kom daarna hier terug.
...
[de rekensom zelf uitgeschreven](https://live.tips/nl/blog/bouw-een-fooienpot-op-je-eigen-stripe-account/).
...
[hoe live.tips met geld omgaat](https://live.tips/nl/blog/hoe-live-tips-met-geld-omgaat/), en waarom het
[één code is in plaats van één per aanbieder](https://live.tips/nl/blog/een-qr-code-elke-betaalmethode/).
