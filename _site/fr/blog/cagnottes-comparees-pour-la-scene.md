# Cagnotte en ligne pour musicien de rue : Ko-fi, Buy Me a Coffee et TipTopJar comparés

> Trois produits corrects pour les créateurs sur internet. Un musicien de rue n'est pas un créateur sur internet. Ton public est devant toi et tu as huit secondes — pourquoi 0 % n'est pas la même chose que rien, et pourquoi un pourboire de 5 € doit arriver comme 5 €.

Canonical: https://live.tips/fr/blog/cagnottes-comparees-pour-la-scene/
...
![Deux façons pour un pourboire d'atteindre un artiste : via une plateforme, un solde retenu et une file d'attente de virement, ou directement du fan à l'artiste.](https://live.tips/blog/tip-jars-compared-for-live-performers/assets/money-path-fr.svg)
...
parcours de l'argent dans [comment live.tips gère l'argent](https://live.tips/fr/blog/comment-live-tips-gere-argent/).
...
continuerait de fonctionner, parce qu'il pointe vers [ton propre lien Stripe](https://live.tips/fr/blog/un-qr-code-tous-moyens-paiement/),
pas vers nous.
...
Ouvre l'[app](https://live.tips/app/?lang=fr), laisse Stripe en mode démo, et lance un pourboire de
