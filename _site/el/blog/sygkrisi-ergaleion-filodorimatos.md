# Φιλοδώρημα online για μουσικούς του δρόμου: Ko-fi, Buy Me a Coffee και TipTopJar σε σύγκριση

> Τρία αξιοπρεπή προϊόντα για δημιουργούς στο διαδίκτυο. Ένας μουσικός του δρόμου δεν είναι δημιουργός στο διαδίκτυο. Το κοινό σου στέκεται μπροστά σου κι έχεις οκτώ δευτερόλεπτα — γιατί το 0% δεν είναι το ίδιο με το τίποτα, και γιατί ένα φιλοδώρημα των €5 πρέπει να φτάνει ως €5.

Canonical: https://live.tips/el/blog/sygkrisi-ergaleion-filodorimatos/
...
![Δύο τρόποι που ένα φιλοδώρημα φτάνει σ' έναν καλλιτέχνη: μέσα από μια πλατφόρμα, ένα κρατημένο υπόλοιπο και μια ουρά εκταμίευσης, ή κατευθείαν από τον θαυμαστή στον καλλιτέχνη.](https://live.tips/blog/tip-jars-compared-for-live-performers/assets/money-path-el.svg)
...
επικολλάς, και η εφαρμογή μιλά με το `api.stripe.com` και με πουθενά αλλού. *Μπορείς*
να συνδεθείς, αν θέλεις οι μπάντες σου και το ιστορικό σου να σε ακολουθήσουν σε μια
δεύτερη συσκευή — αλλά τίποτα δεν σου το ζητά, και το προεπιλεγμένο είναι να μένεις
αποσυνδεδεμένος. Γράψαμε
ολόκληρη τη διαδρομή του χρήματος στο [πώς το live.tips διαχειρίζεται τα
χρήματα](https://live.tips/el/blog/pos-to-live-tips-diacheirizetai-ta-chrimata/).
...
| **Λογαριασμός στο εργαλείο** | προαιρετικός | απαιτείται | απαιτείται | απαιτείται, συν έλεγχος ταυτότητας |
...
γιατί δείχνει στον [δικό σου σύνδεσμο Stripe](https://live.tips/el/blog/enas-kodikos-qr-gia-kathe-tropo-pliromis/),
όχι σ' εμάς.
...
Άνοιξε την [εφαρμογή](https://live.tips/app/?lang=el), άφησε το Stripe σε λειτουργία demo, και ρίξε
