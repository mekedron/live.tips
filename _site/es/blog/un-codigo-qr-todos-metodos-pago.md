# Un código QR, todos los métodos de pago

> La mayoría de las herramientas de propinas te dan un código por cada proveedor de pago. Pega tres a un pie de micrófono y observa cómo la gente se rinde. Aquí está por qué live.tips se queda con uno.

Canonical: https://live.tips/es/blog/un-codigo-qr-todos-metodos-pago/
...
sobre ello por separado en [cómo live.tips gestiona el dinero](https://live.tips/es/blog/como-live-tips-gestiona-dinero/) —
...
Abre la [app](https://live.tips/app/?lang=es), deja Stripe en modo demo y apunta tu propio teléfono al
