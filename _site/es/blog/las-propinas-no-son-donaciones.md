...
viven [enteramente fuera de Stripe](https://live.tips/es/blog/un-codigo-qr-todos-metodos-pago/) en
nuestra app.
...
[a qué nombre de host de Stripe apunta tu código QR](https://live.tips/es/blog/monta-un-bote-de-propinas-en-tu-propia-cuenta-de-stripe/),
y si quieres el panorama completo de a dónde va realmente el dinero, está
[aquí](https://live.tips/es/blog/como-live-tips-gestiona-dinero/).
