# En QR-kod, varje betalningsmetod

> De flesta dricksverktyg ger dig en kod per betalningsleverantör. Tejpa tre på ett mikrofonstativ och se folk ge upp. Här är varför live.tips håller sig till en.

Canonical: https://live.tips/sv/blog/en-qr-kod-varje-betalningsmetod/
...
separat i [så hanterar live.tips pengar](https://live.tips/sv/blog/sa-hanterar-live-tips-pengar/) – värt
fem minuter om du är den sortens person som läser villkoren innan du tejpar något
på ditt gitarrfodral. Det bör du vara.

## Testa det

Öppna [appen](https://live.tips/app/?lang=sv), lämna Stripe i demoläge och rikta din egen telefon
