# Tipkrukke online til gademusikere: Ko-fi, Buy Me a Coffee og TipTopJar sammenlignet

> Tre udmærkede produkter til kreative på nettet. En gademusiker er ikke en kreativ på nettet. Dit publikum står lige foran dig, og du har otte sekunder — hvorfor 0 % ikke er det samme som ingenting, og hvorfor et tip på 5 € bør ankomme som 5 €.

Canonical: https://live.tips/da/blog/tipkrukker-sammenlignet/
...
![To måder et tip når frem til en optrædende: gennem en platform, en tilbageholdt saldo og en udbetalingskø, eller direkte fra fanen til kunstneren.](https://live.tips/blog/tip-jars-compared-for-live-performers/assets/money-path-da.svg)
...
`api.stripe.com` og intet andet sted. Du *kan* logge ind, hvis du vil have dine
bands og din historik med over på en enhed nummer to — men intet beder dig om det,
og logget ud er standard. Vi har skrevet hele pengevejen op i
...
| **Konto hos værktøjet** | valgfri | påkrævet | påkrævet | påkrævet, plus en id-kontrol |
...
peger på [dit eget Stripe-link](https://live.tips/da/blog/en-qr-kode-hver-betalingsmetode/), ikke på os.
...
Åbn [appen](https://live.tips/app/?lang=da), lad Stripe stå i demo-tilstand, og kast et demo-tip i
