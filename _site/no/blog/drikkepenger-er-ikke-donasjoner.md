# Drikkepenger er ikke donasjoner — og Stripe behandler dem som to forskjellige virksomheter

> En gatemusikant som ber om en «donasjonsknapp», beskriver en virksomhet Stripe forbyr i store deler av Europa. Drikkepenger betaler for en tjeneste du allerede har utført; en donasjon er innsamling til veldedig formål. Forskjellen avgjør hvilken kategori kontoen din havner i — og én enkelt API-parameter kan velge feil for deg.

Canonical: https://live.tips/no/blog/drikkepenger-er-ikke-donasjoner/
...
det er derfor de lever [helt utenfor Stripe](https://live.tips/no/blog/en-qr-kode-hver-betalingsmate/)
i appen vår.
...
[hvilket Stripe-vertsnavn QR-koden din peker på](https://live.tips/no/blog/bygg-en-tipskrukke-pa-din-egen-stripe-konto/),
og vil du ha det større bildet av hvor pengene faktisk går, er det
[her](https://live.tips/no/blog/slik-handterer-live-tips-penger/).
