# Bezkontaktní spropitné pro pouliční muzikanty — poctivě spočítané

> Tap to Pay na telefonu, čtečka karet, NFC nálepka, QR kód — čtyři různé věci, kterým se všem říká „bezkontaktní". Co každá z nich v roce 2026 doopravdy stojí, co NFC tag ve skutečnosti dělá (není to, co si myslíš) a kdy přiložení vyhraje nad naskenováním.

Canonical: https://live.tips/cs/blog/bezkontaktni-spropitne-pro-poulicni-muzikanty/
...
kartou](https://live.tips/cs/blog/platby-kartou-pro-poulicni-muzikanty/) a pak se sem vrať.
...
a [sami jsme si tu matematiku sepsali](https://live.tips/cs/blog/postavte-si-kasicku-na-spropitne-na-vlastnim-uctu-stripe/).
...
sepsali v [jak live.tips zachází s penězi](https://live.tips/cs/blog/jak-live-tips-naklada-s-penezi/) a proč je
to [jeden kód místo jednoho na každého poskytovatele](https://live.tips/cs/blog/jeden-qr-kod-vsechny-platebni-metody/)
taky.
