# Pote de gorjetas online para músicos de rua: Ko-fi, Buy Me a Coffee e TipTopJar comparados

> Três produtos decentes para criadores na internet. Um músico de rua não é um criador na internet. O teu público está à tua frente e tens oito segundos — porque 0% não é o mesmo que nada, e porque uma gorjeta de 5 € deve chegar como 5 €.

Canonical: https://live.tips/pt/blog/potes-de-gorjetas-comparados/
...
![Duas formas de uma gorjeta chegar a um artista: através de uma plataforma, um saldo retido e uma fila de pagamento, ou diretamente do fã para o artista.](https://live.tips/blog/tip-jars-compared-for-live-performers/assets/money-path-pt.svg)
...
para o [teu próprio link Stripe](https://live.tips/pt/blog/um-codigo-qr-todos-os-metodos/), não para nós.
...
Abre a [app](https://live.tips/app/?lang=pt), deixa o Stripe em modo demo, e atira uma gorjeta de
