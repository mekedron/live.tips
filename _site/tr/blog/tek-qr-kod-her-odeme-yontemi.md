# Tek QR kod, her ödeme yöntemi

> Çoğu bahşiş aracı sana her ödeme sağlayıcısı için bir kod verir. Üç tanesini mikrofon sehpasına yapıştır ve insanların pes edişini izle. İşte live.tips neden tek kodda kalıyor.

Canonical: https://live.tips/tr/blog/tek-qr-kod-her-odeme-yontemi/
...
[live.tips parayı nasıl yönetir](https://live.tips/tr/blog/live-tips-parayi-nasil-yonetir/) yazısında anlattık
— gitar kutuna bir şey yapıştırmadan önce şartları okuyan türden biriysen, beş
dakikaya değer. Öyle biri olmalısın.

## Dene

[Uygulamayı](https://live.tips/app/?lang=tr) aç, Stripe'ı demo modunda bırak ve kendi telefonunu
