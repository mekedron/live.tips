# Sokak müzisyenleri için temassız bahşiş, dürüstçe

> Telefonda Tap to Pay, bir kart okuyucu, bir NFC etiketi, bir QR kod — hepsine «temassız» denen dört ayrı şey. 2026'da her birinin gerçekte neye mal olduğu, bir NFC etiketinin aslında ne yaptığı (sandığın şey değil) ve dokunmanın taramayı ne zaman geçtiği.

Canonical: https://live.tips/tr/blog/sokak-muzisyenleri-icin-temassiz-bahsis/
...
müzisyenleri kartla ödemeyi nasıl alıyor](https://live.tips/tr/blog/sokak-muzisyenleri-icin-kartli-odeme/)
...
[aritmetiğini kendimiz yazdık](https://live.tips/tr/blog/kendi-stripe-hesabinizda-bahsis-kavanozu-kurun/).
...
[live.tips parayı nasıl yönetiyor](https://live.tips/tr/blog/live-tips-parayi-nasil-yonetir/) yazısında anlattık, ve neden
[her sağlayıcı için ayrı değil, tek bir kod](https://live.tips/tr/blog/tek-qr-kod-her-odeme-yontemi/) olduğunu da.
