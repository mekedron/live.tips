# Contactless tipping for street performers, honestly

> Tap-to-pay on a phone, a card reader, an NFC sticker, a QR code — four different things that get called "contactless". What each one actually costs in 2026, what an NFC tag really does (it is not what you think), and when a tap beats a scan.

Canonical: https://live.tips/blog/contactless-tipping-for-street-performers/
...
payments](https://live.tips/blog/how-buskers-take-card-payments/) and come back here.
...
That is true, and we have [written the maths out ourselves](https://live.tips/blog/build-a-tip-jar-on-your-own-stripe/).
...
[how live.tips handles money](https://live.tips/blog/how-live-tips-handles-money/), and why it is
[one code rather than one per provider](https://live.tips/blog/one-qr-code-every-payment-method/).
