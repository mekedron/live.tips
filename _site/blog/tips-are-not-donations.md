# Tips are not donations — and Stripe treats them as two different businesses
...
Canonical: https://live.tips/blog/tips-are-not-donations/
...
[entirely outside Stripe](https://live.tips/blog/one-qr-code-every-payment-method/) in our app.
...
[which Stripe hostname your QR code points at](https://live.tips/blog/build-a-tip-jar-on-your-own-stripe/),
and if you want the wider picture of where the money actually goes, that is
[here](https://live.tips/blog/how-live-tips-handles-money/).
