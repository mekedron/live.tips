...
List<InstallStep> installSteps({required bool apple}) => apple
    ? const [
        InstallStep(Icons.ios_share_rounded,
            'Tap the Share button in Safari’s toolbar.'),
        InstallStep(Icons.add_box_outlined,
            'Scroll down and choose “Add to Home Screen”.'),
        InstallStep(Icons.rocket_launch_rounded,
            'Open live.tips from your Home Screen — full-screen.'),
      ]
    : const [
        InstallStep(Icons.more_vert_rounded,
            'Tap the ⋮ menu in your browser’s toolbar.'),
        InstallStep(Icons.install_mobile_rounded,
