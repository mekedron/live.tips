...
puțin în numele tău — și tocmai asta e ideea.

## Ce este live.tips

live.tips este **software pe care îl rulezi tu însuți**. Îți transformă propriul cont de Stripe (sau
Revolut, MobilePay, Monzo) într-un borcan de bacșiș live, cu un cod QR și un ecran care se umple
pe măsură ce fanii lasă bacșiș.

## Ce nu este live.tips
...
- Nu luăm **niciun comision** și nu percepem **niciun tarif**. Nu ai ce să ne plătești.
- **Nu putem rambursa un bacșiș**, pentru că nu l-am avut niciodată. Rambursările țin de artist și
  de furnizorul lui de plăți.
- **Nu putem vedea, bloca, anula sau recupera** nicio plată.
- Relația ta pentru banii propriu-ziși este cu **Stripe, Revolut, MobilePay sau Monzo**,
  conform termenilor lor — nu cu noi.

## Bacșișurile sunt plăți pentru o prestație

Bacșișurile colectate prin live.tips sunt **plăți voluntare către un artist pentru prestația lui live**.
Ele **nu sunt donații caritabile**, iar live.tips nu este o platformă de strângere de fonduri. Artiștii
trebuie să își descrie activitatea către furnizorul lor de plăți în consecință — Stripe, în special,
...
- **Propriul tău cont de plată** — să îl menții în regulă și să respecți regulile Stripe sau ale
  Revolut, MobilePay ori Monzo.
- **Taxele tale.** Bacșișurile sunt venit. Nu raportăm nimic nimănui, nu emitem niciun document fiscal
  și nu știm cât ai câștigat.
...
- Bacșișul este **voluntar** și, odată trimis, un bacșiș este de regulă **definitiv** — un bacșiș live
  nu este o cumpărare cu drept de returnare.
- Dacă ceva a mers prost cu o plată, discută cu **artistul** sau cu furnizorul de plăți care a procesat-o.
...
Revolut, MobilePay și Monzo nu oferă unei aplicații **nicio modalitate de a confirma că o plată chiar a
avut loc**. Un bacșiș trimis prin acele metode apare pe ecranul artistului **în clipa în care fanul
trimite formularul** — indiferent dacă apoi duce sau nu plata la capăt.

live.tips etichetează aceste bacșișuri drept **neverificate**, iar asta înseamnă exact ce spune:
*cineva a zis că a plătit.* Sunt un efect de scenă, nu o chitanță.

**Nu trata niciodată un bacșiș neverificat ca dovadă de plată.** Artiștii trebuie să facă reconcilierea
...
live.tips este furnizat **„ca atare”, fără garanții de niciun fel**, exprese sau implicite,
...
finanțeze o răspundere, și nu se acceptă niciuna.

Două limite oneste ale acelui paragraf, pentru că un termen care exagerează nu valorează nimic:

- **Nu** excludem răspunderea pentru **deces sau vătămare corporală cauzate de neglijență, pentru
  fraudă sau pentru orice altceva care nu poate fi exclus în mod legal**.
- Dacă ești **consumator**, îți păstrezi toate **drepturile imperative pe care ți le acordă legislația ta
  locală**. Nimic de aici nu ți le ia.

## Software-ul este al tău

live.tips este licențiat MIT. Ai voie să îl **citești, să îl derivezi, să îl modifici, să îl găzduiești
singur și să îl rulezi tu însuți** — inclusiv releul. Dacă nu îți place cum operăm serviciul, răspunsul
sincer pe care ți-l dă open source-ul este: rulează-ți propriul serviciu. Sursa se află la
...
Putem actualiza acești termeni pe măsură ce software-ul se schimbă. Fiecare versiune anterioară se află
în istoricul git public, așa că poți vedea exact ce s-a schimbat și când. Continuarea utilizării
serviciului după o modificare înseamnă că o accepți.

## Contact

**[contact@live.tips](mailto:contact@live.tips)** — o citește un om adevărat.

## Limbă

Acești termeni sunt publicați în fiecare limbă acceptată de site, pentru comoditate. Dacă o traducere
