...
Käyttämällä live.tipsiä hyväksyt seuraavan. Se on lyhyt, koska live.tips tekee hyvin vähän
sinun puolestasi — ja juuri se on pointti.

## Mitä live.tips on

live.tips on **ohjelmisto, jota ajat itse**. Se muuttaa oman Stripe- (tai Revolut-,
MobilePay-, Monzo-) tilisi live-tippipurkiksi, jossa on QR-koodi ja näyttö, joka täyttyy
fanien tipatessa.

## Mitä live.tips ei ole
...
- Emme ota **mitään komissiota** emmekä veloita **mitään maksua**. Meille ei ole mitään
  maksettavaa.
- **Emme voi palauttaa tippiä**, koska se ei koskaan ollut meillä. Palautukset kuuluvat
  artistille ja hänen maksupalveluntarjoajalleen.
- **Emme voi nähdä, jäädyttää, peruuttaa emmekä palauttaa** yhtäkään maksua.
- Itse rahaa koskeva suhteesi on **Stripen, Revolutin, MobilePayn tai Monzon** kanssa, heidän
  ehtojensa mukaisesti — ei meidän kanssamme.

## Tipit ovat maksuja esityksestä

live.tipsin kautta kerätyt tipit ovat **vapaaehtoisia maksuja artistille hänen
live-esityksestään**. Ne **eivät ole hyväntekeväisyyslahjoituksia**, eikä live.tips ole
varainkeruualusta. Artistien on kuvattava toimintansa maksupalveluntarjoajalleen tämän
...
- **Oma maksutilisi** — sen pitäminen moitteettomassa kunnossa ja Stripen, Revolutin,
  MobilePayn tai Monzon sääntöjen noudattaminen.
- **Verosi.** Tipit ovat tuloa. Emme raportoi mitään kenellekään, emme anna mitään
  veroasiakirjaa emmekä tiedä, mitä ansaitsit.
...
- Tippaaminen on **vapaaehtoista**, ja kerran lähetettynä tippi on yleensä **lopullinen** —
  live-tippi ei ole ostos, johon liittyisi palautusoikeus.
- Jos maksun kanssa meni jokin pieleen, ota asia esiin **artistin** kanssa tai maksun
  käsitelleen maksupalveluntarjoajan kanssa. Meillä ei ole siitä mitään tietoa eikä valtaa
  siihen.
...
Revolut, MobilePay ja Monzo eivät anna sovellukselle **mitään tapaa vahvistaa, että maksu
todella tapahtui**. Näillä tavoilla lähetetty tippi ilmestyy artistin näytölle **sillä
hetkellä, kun fani lähettää lomakkeen** — riippumatta siitä, viekö hän maksun sen jälkeen
loppuun.

live.tips merkitsee nämä tipit **vahvistamattomiksi**, ja se tarkoittaa täsmälleen sitä:
*joku sanoi maksaneensa.* Ne ovat lavatehoste, eivät kuitti.

**Älä koskaan pidä vahvistamatonta tippiä todisteena maksusta.** Artistien on täsmäytettävä
...
- Voimme **muuttaa välitintä tai sulkea sen kokonaan**. Jos joskus teemme niin, pelkkää
...
live.tips tarjotaan **”sellaisena kuin se on”, ilman minkäänlaista takuuta**, nimenomaista tai
konkludenttista, mukaan lukien mikä tahansa takuu kaupallisesta hyödynnettävyydestä,
...
Kaksi rehellistä rajoitusta tuohon kappaleeseen, koska liian pitkälle menevä ehto ei ole minkään
arvoinen:

- Emme sulje pois vastuuta **kuolemasta tai henkilövahingosta, joka johtuu huolimattomuudesta,
  petoksesta, tai mistään muusta, jota ei laillisesti voi sulkea pois**.
- Jos olet **kuluttaja**, säilytät kaikki **pakottavat oikeudet, jotka paikallinen lakisi sinulle
  antaa**. Mikään tässä ei vie niitä pois.

## Ohjelmisto on sinun

live.tips on MIT-lisensoitu. Saat **lukea, forkata, muokata, isännöidä itse ja ajaa sitä itse**
— mukaan lukien välittimen. Jos et pidä siitä, miten me palvelua ylläpidämme, avoimen lähdekoodin
rehellinen vastaus on: pyöritä omaasi. Lähdekoodi on osoitteessa
...
Voimme päivittää näitä ehtoja ohjelmiston muuttuessa. Jokainen aiempi versio on julkisessa
git-historiassa, joten voit nähdä tarkalleen, mikä muuttui ja milloin. Palvelun käytön
jatkaminen muutoksen jälkeen tarkoittaa, että hyväksyt sen.

## Yhteystiedot

**[contact@live.tips](mailto:contact@live.tips)** — sen lukee oikea ihminen.

## Kieli

Nämä ehdot julkaistaan kaikilla sivuston tukemilla kielillä helpottaaksemme lukemista. Jos
