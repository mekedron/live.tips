...
![Duas formas de uma gorjeta chegar a um artista: através de uma plataforma, um saldo retido e uma fila de pagamento, ou diretamente do fã para o artista.](assets/money-path-pt.svg)
