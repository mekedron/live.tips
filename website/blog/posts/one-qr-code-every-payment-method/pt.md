---
title: Um código QR, todos os métodos de pagamento
description: A maioria das ferramentas de gorjetas dá-te um código por cada fornecedor de pagamento. Cola três à haste do microfone e vê as pessoas desistirem. Aqui está porque a live.tips se fica por um.
slug: um-codigo-qr-todos-os-metodos
---
...
[como a live.tips lida com o dinheiro](post:how-live-tips-handles-money) — cinco
minutos bem gastos se és do tipo de pessoa que lê os termos antes de colar seja o
que for ao estojo da guitarra. Deves ser.

## Experimenta

Abre a [app](/app/?lang=pt), deixa a Stripe em modo de demonstração e aponta o
