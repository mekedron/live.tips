---
title: Como os artistas de rua aceitam pagamentos com cartão agora que ninguém anda com dinheiro
description: Terminais de pagamento, tap-to-pay no telemóvel, códigos QR de apps de pagamento, plataformas de gorjetas. Quanto custa mesmo cada opção, o que faz a uma gorjeta de 2 €, e como escolher — por quem constrói uma destas ferramentas e mesmo assim lhe dirá para comprar um SumUp se for essa a resposta.
slug: pagamentos-com-cartao-artistas-de-rua
---

Tocou bem. As pessoas estavam em três filas, alguém filmou tudo, e uma mulher de
...
honestidade](post:contactless-tipping-for-street-performers) — o que um autocolante
...
[Um código QR, todos os métodos de pagamento](post:one-qr-code-every-payment-method).
...
[Ko-fi, Buy Me a Coffee, TipTopJar — e os oito segundos que realmente tem](post:tip-jars-compared-for-live-performers).
...
Para esse último pode [experimentar o nosso](/app/?lang=pt) — modo demo, sem conta
