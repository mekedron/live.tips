---
title: Construisez une cagnotte à pourboires sur votre propre compte Stripe
description: Trois appels d'API suffisent pour obtenir une page hébergée « prix libre » avec Apple Pay et Google Pay, sans le moindre serveur. Voici le montage complet : la clé restreinte, les permissions, comment récupérer les pourboires sans webhook, et le calcul des frais que personne n'imprime.
slug: construire-une-cagnotte-sur-votre-propre-compte-stripe
---
