---
title: Kontaktløse drikkepenge til gademusikanter — ærligt regnet ud
description: Tap to Pay på telefonen, en kortlæser, et NFC-klistermærke, en QR-kode — fire forskellige ting, der alle kaldes »kontaktløse«. Hvad hver af dem faktisk koster i 2026, hvad et NFC-tag i virkeligheden gør (ikke det, du tror), og hvornår et tryk slår et scan.
slug: kontaktlose-drikkepenge-til-gademusikanter
---
...
kortbetalinger](post:how-buskers-take-card-payments) og kom tilbage hertil bagefter.
...
[selv skrevet regnestykket op](post:build-a-tip-jar-on-your-own-stripe).
...
[hvordan live.tips håndterer penge](post:how-live-tips-handles-money), og hvorfor det
er [én kode frem for én pr. udbyder](post:one-qr-code-every-payment-method).
