---
title: Gorjetas sem contacto para músicos de rua, com honestidade
description: Tap to Pay no telemóvel, um leitor de cartões, um autocolante NFC, um código QR — quatro coisas diferentes a que se chama «sem contacto». Quanto custa realmente cada uma em 2026, o que uma etiqueta NFC faz de facto (não é o que pensas) e quando um toque ganha a uma leitura.
slug: gorjetas-sem-contacto-para-musicos-de-rua
---
...
cartão](post:how-buskers-take-card-payments) e volta cá depois.
...
[escrevemos as contas](post:build-a-tip-jar-on-your-own-stripe).
...
dinheiro em [como o live.tips lida com o dinheiro](post:how-live-tips-handles-money),
e porque é [um código em vez de um por fornecedor](post:one-qr-code-every-payment-method).
