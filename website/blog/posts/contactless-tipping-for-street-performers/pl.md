---
title: Napiwki zbliżeniowe dla ulicznych muzyków — szczerze policzone
description: Tap to Pay na telefonie, terminal kartowy, naklejka NFC, kod QR — cztery różne rzeczy, które wszystkie nazywa się „zbliżeniowymi". Ile każda z nich naprawdę kosztuje w 2026, co tak naprawdę robi tag NFC (nie to, co myślisz) i kiedy przyłożenie wygrywa ze skanem.
slug: platnosci-zblizeniowe-dla-muzykow-ulicznych
---
...
kartą](post:how-buskers-take-card-payments) i wróć tu potem.
...
prawda i sami [rozpisaliśmy ten rachunek](post:build-a-tip-jar-on-your-own-stripe).
...
[jak live.tips obchodzi się z pieniędzmi](post:how-live-tips-handles-money), a to,
dlaczego jest to [jeden kod, a nie po jednym na dostawcę](post:one-qr-code-every-payment-method),
też.
