---
title: Mance contactless per artisti di strada, onestamente
description: Tap to Pay sul telefono, un lettore di carte, un adesivo NFC, un codice QR — quattro cose diverse che vengono tutte chiamate «contactless». Quanto costa davvero ciascuna nel 2026, cosa fa realmente un tag NFC (non è quello che pensi) e quando un tap batte una scansione.
slug: mance-contactless-per-artisti-di-strada
---
...
carta](post:how-buskers-take-card-payments) e poi torna qui.
...
[il conto ce lo siamo scritto da soli](post:build-a-tip-jar-on-your-own-stripe).
...
[come live.tips gestisce il denaro](post:how-live-tips-handles-money), e perché è
[un codice solo invece di uno per fornitore](post:one-qr-code-every-payment-method).
