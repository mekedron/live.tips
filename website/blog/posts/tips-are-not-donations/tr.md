---
title: Bahşiş bağış değildir — ve Stripe bunları iki ayrı iş kolu sayar
description: «Bağış butonu» isteyen bir sokak müzisyeni, aslında Stripe'ın Avrupa'nın büyük bölümünde yasakladığı bir iş kolunu tarif ediyordur. Bahşiş, zaten yaptığın bir hizmetin karşılığıdır; bağış ise hayır amaçlı para toplamaktır. Bu fark, hesabının hangi kategoriye düşeceğine karar verir — ve tek bir API parametresi bu seçimi senin yerine yapabilir.
slug: bahsis-bagis-degildir
---
...
[tamamen Stripe'ın dışında](post:one-qr-code-every-payment-method) durmasının
nedeni de budur.
...
[QR kodunun hangi Stripe alan adına işaret ettiğine](post:build-a-tip-jar-on-your-own-stripe)
kadar; paranın gerçekte nereye gittiğine dair geniş resmi istiyorsan, o da
[burada](post:how-live-tips-handles-money).
