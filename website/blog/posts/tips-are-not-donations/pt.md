...
[inteiramente fora da Stripe](post:one-qr-code-every-payment-method) na nossa app.
...
[para que nome de anfitrião da Stripe aponta o teu código QR](post:build-a-tip-jar-on-your-own-stripe),
e se quiseres o quadro mais amplo de para onde vai realmente o dinheiro, está
[aqui](post:how-live-tips-handles-money).
