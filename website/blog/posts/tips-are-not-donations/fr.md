...
[entièrement en dehors de Stripe](post:one-qr-code-every-payment-method) dans notre
app.
...
[nom d'hôte Stripe vers lequel pointe ton QR code](post:build-a-tip-jar-on-your-own-stripe),
et si tu veux le tableau plus large de l'endroit où va réellement l'argent, c'est
[ici](post:how-live-tips-handles-money).
