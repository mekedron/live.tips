---
title: Napiwek to nie darowizna — a Stripe traktuje je jak dwa różne biznesy
description: Uliczny muzyk, który prosi o „przycisk darowizny", opisuje działalność, której Stripe w większości Europy zakazuje. Napiwek płaci za usługę już wykonaną; darowizna to zbiórka na cele charytatywne. Ta różnica decyduje, do jakiej kategorii trafi twoje konto — a jeden parametr API potrafi wybrać za ciebie tę złą.
slug: napiwek-to-nie-darowizna
---
...
[całkowicie poza Stripe](post:one-qr-code-every-payment-method).
...
[na jaki host Stripe'a wskazuje twój kod QR](post:build-a-tip-jar-on-your-own-stripe), a
jeśli chcesz szerszy obraz tego, dokąd naprawdę idą pieniądze, jest
[tutaj](post:how-live-tips-handles-money).
