...
[helemaal buiten Stripe](post:one-qr-code-every-payment-method) in onze app.
...
[naar welke Stripe-hostnaam je QR-code wijst](post:build-a-tip-jar-on-your-own-stripe),
en wil je het bredere plaatje van waar het geld werkelijk heen gaat, dan staat dat
[hier](post:how-live-tips-handles-money).
